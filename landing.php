...
<body>
    ...
    <nav>
        <div class="container">
            ...
            <div class="auth-buttons">
                <a href="index.php?from_landing=1" class="btn btn-login">Login</a>
                <a href="index.php?from_landing=1" class="btn btn-signup">Sign Up</a>
            </div>
        </div>
    </nav>
    ...
    <section class="hero">
        <div class="container">
            ...
            <div class="cta-buttons">
                <a href="index.php?from_landing=1" class="btn-primary">Get Started</a>
    ...
    <section class="cta-section">
        <div class="container">
            ...
            <a href="index.php?from_landing=1" class="btn-primary">Create Your Account Now</a>
        </div>
    </section>
