const JobsModule = (() => {
    ...
    const renderJobs = (jobs) => {
        ...
        jobsList.innerHTML = jobs.map(job => {
            ...
            return `
                <div style="background:${cardBg}; border-radius:8px; padding:20px; margin-bottom:16px; border-left:5px solid ${statusColor}; box-shadow:0 2px 8px rgba(0,0,0,${isDarkMode ? '0.3' : '0.08'}); transition:all 0.25s ease; cursor:pointer;" onmouseover="this.style.backgroundColor='${isDarkMode ? 'rgba(25, 118, 210, 0.15)' : 'rgba(25, 118, 210, 0.1)'}'; this.style.boxShadow='0 2px 10px rgba(0,0,0,${isDarkMode ? '0.4' : '0.15'})';" onmouseout="this.style.backgroundColor='${cardBg}'; this.style.boxShadow='0 2px 8px rgba(0,0,0,${isDarkMode ? '0.3' : '0.08'})';">
    ...
    const renderMyApplications = (applications) => {
        ...
        appsList.innerHTML = applications.map(app => {
            ...
            return `
                <div style="background:${cardBg}; border-radius:8px; overflow:hidden; margin-bottom:16px; box-shadow:0 2px 8px rgba(0,0,0,${isDarkMode ? '0.3' : '0.08'}); border-left:5px solid ${status.color}; transition:all 0.25s ease; cursor:pointer;" onmouseover="this.style.backgroundColor='${isDarkMode ? 'rgba(25, 118, 210, 0.15)' : 'rgba(25, 118, 210, 0.1)'}'; this.style.boxShadow='0 2px 10px rgba(0,0,0,${isDarkMode ? '0.4' : '0.15'})';" onmouseout="this.style.backgroundColor='${cardBg}'; this.style.boxShadow='0 2px 8px rgba(0,0,0,${isDarkMode ? '0.3' : '0.08'})';">
    ...
    const renderMyJobs = (jobs) => {
        ...
        myJobsList.innerHTML = jobs.map(job => {
            ...
            return `
                <div style="background:${cardBg}; border-radius:8px; overflow:hidden; margin-bottom:16px; box-shadow:0 2px 8px rgba(0,0,0,${isDarkMode ? '0.3' : '0.08'}); border-left:5px solid ${statusColor}; transition:all 0.25s ease; cursor:pointer;" onmouseover="this.style.backgroundColor='${isDarkMode ? 'rgba(25, 118, 210, 0.15)' : 'rgba(25, 118, 210, 0.1)'}'; this.style.boxShadow='0 2px 10px rgba(0,0,0,${isDarkMode ? '0.4' : '0.15'})';" onmouseout="this.style.backgroundColor='${cardBg}'; this.style.boxShadow='0 2px 8px rgba(0,0,0,${isDarkMode ? '0.3' : '0.08'})';">
